...
def GetDistance():
    ...
    Mat_1 = np.matrix([Beacons(list_beacons(1))[1]-Beacons(list_beacons(2))[1]],[Beacons(list_beacons(1))[2]-Beacons(list_beacons(3))[2]],[Beacons(list_beacons(2))[1]-Beacons(list_beacons(3))[1]],[Beacons(list_beacons(2))[2]-Beacons(list_beacons(3))[2]])
    
    Mat_2 = np.matrix(Beacons(list_beacons(1))[1]^2-Beacons(list_beacons(3))[1]^2 + Beacons(list_beacons(1))[2]^2-Beacons(list_beacons(3))[2]^2 - distance_vals[1]^2 + distance_vals[3]^2, Beacons(list_beacons(2))[1]^2-Beacons(list_beacons(3))[1]^2 + Beacons(list_beacons(2))[2]^2-Beacons(list_beacons(3))[2]^2 - distance_vals[2]^2 + distance_vals[3]^2)
